window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right-angle-triangle requires the length of the two different sides of the triangle. Try again.')
		else if ( b !== 'float' )
	...
	displayFunctionForRectangle: function() {
		document.getElementById('functionRectangle').innerHTML += 'float area_right-angle-triangle	(float a,float b)<br>{<br> &emsp; float area = a*b/2;<br> &emsp; return area;<br>}'
	},
